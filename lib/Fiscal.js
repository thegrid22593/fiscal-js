...
var Fiscal = (function () {
    ...
    Fiscal.prototype.presentValue = function (terminalValue, rate, numberOfYears) {
        ...
        return new currency_1.Currency(Math.round(pv * 100) / 100, this.options.format);
    };
    Fiscal.prototype.futureValue = function (initialInvestment, rate, numberOfYears) {
        ...
        return new currency_1.Currency(Math.round(futureValue * 100) / 100, this.options.format);
    };
    Fiscal.prototype.netPresentValue = function (principal, rate, cashFlows) {
        ...
        return new currency_1.Currency(Math.round(netPresentValue * 100) / 100, this.options.format);
    };
    Fiscal.prototype.compoundInterest = function (principal, rate, numberOfYears) {
        ...
        return new currency_1.Currency(principal * rateTimesYearSum, this.options.format);
    };
    Fiscal.prototype.simpleInterest = function (principal, rate, numberOfYears) {
        ...
        return new currency_1.Currency(finalAmount, this.options.format);
    };
    ...
    Fiscal.prototype.discountedCashFlow = function (principal, cashFlows, rate) {
        ...
        return new currency_1.Currency(terminalValue, this.options.format);
    };
    ...
    Fiscal.prototype.amortization = function (principal, rate, totalNumberOfPayments, intervalInMonths, includeInitialPayment) {
        ...
        return new currency_1.Currency(Math.round(monthlyPayment * 100) / 100, this.options.format);
    };
    ...
    Fiscal.prototype.getSalaryPerYear = function (hourlyRate, taxRate) {
        ...
        return new currency_1.Currency(yearlySalary - taxes);
    };
    Fiscal.prototype.getSalaryPerMonth = function (hourlyRate, taxRate) {
        if (taxRate === void 0) { taxRate = 0; }
        var weeksPerMonth = 4;
        var workingHoursPerWeek = 40;
        var monthlySalary = (hourlyRate * workingHoursPerWeek) * weeksPerMonth;
        var taxes = monthlySalary * new percent_1.Percent(taxRate / 12).asDecimal();
        return new currency_1.Currency(monthlySalary - taxes);
    };
    Fiscal.prototype.getHourlyWage = function (salary) {
        var weeksPerYear = 52;
        var workingHoursPerWeek = 40;
        var hourlyWage = (salary / weeksPerYear) / workingHoursPerWeek;
        return new currency_1.Currency(hourlyWage);
    };
    ...
    Fiscal.prototype.yearOverYear = function (currentYear, pastYear) {
        return new percent_1.Percent((((currentYear - pastYear) / pastYear) * 100));
    };
    Fiscal.prototype.percentOf = function (percent, value) {
        return new currency_1.Currency(value * new percent_1.Percent(percent).asDecimal());
    };
    Fiscal.prototype.returnOnEquity = function (netIncome, shareHoldersEquity) {
        return new percent_1.Percent(Math.round(100 * (netIncome / shareHoldersEquity)));
    };
    return Fiscal;
}());
